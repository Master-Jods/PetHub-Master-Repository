...
export const DashboardLayout = () => {
  ...
  const navItems = useMemo(() => {
    const base = [
      ...
      { section: 'Customers', label: 'Reviews', path: `${workspaceBasePath}/reviews`, icon: MessageSquareText, ownerOnly: true },
      { section: 'Delivery', label: 'Rider Management', path: `${workspaceBasePath}/riders`, icon: Bike, ownerOnly: true },
    ...
    <div className="staff-app staff-workspace min-h-screen bg-[#FFF7F9] text-[#1F2937]">
      <div className="staff-workspace__shell">
        <aside className="staff-workspace__sidebar">
          ...
          <button
            onClick={() => navigate('/')}
            title="Go to PetHub Admin"
            className="staff-workspace__nav-link w-full flex items-center gap-3 rounded-lg px-3 py-2 mt-auto text-slate-600 hover:bg-[#FFF3F5] transition-colors"
          >
            <LayoutDashboard className="staff-workspace__nav-icon h-5 w-5" />
            <span className="staff-workspace__nav-label text-sm">PetHub Admin</span>
          </button>

          <button
            onClick={onSignOut}
            title="Sign out"
            className="staff-workspace__signout mb-1 w-full flex items-center gap-3 rounded-lg px-3 py-2 text-slate-600 hover:bg-[#FFF3F5] transition-colors"
          >
